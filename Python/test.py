...
n = 3 #Query 3 songs, tell me how similar they are
rand = [0]*n

i=0
while i < len(rand):
    rand[i] = random.randrange(0,len(t)-1,2)
    i+=1
    
#Now check similarities
ls = [os.path.join(path,t[i]) for i in rand]

#t = ['classical1.wav','classical2.wav','classical3.wav','jazz1.wav','jazz2.wav','electronic1.wav']
